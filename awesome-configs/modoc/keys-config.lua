...
local layco = redflat.layout.common
...
function hotkeys:init(args)
	...
	local apprunner_keys_move = {
		{
			{ env.mod }, "u", function() apprunner:down() end,
			{ description = "Select next item", group = "Navigation" }
		},
		{
			{ env.mod }, "e", function() apprunner:up() end,
	...
	local menu_keys_move = {
		{
			{ env.mod }, "e", redflat.menu.action.down,
			{ description = "Select next item", group = "Navigation" }
		},
		{
			{ env.mod }, "u", redflat.menu.action.up,
			{ description = "Select previous item", group = "Navigation" }
		},
		{
		...
		{
			{ env.mod }, "i", redflat.menu.action.enter,
	...
	-- group
	keyseq[3] = {
		{ {}, "k", {}, {} }, -- 1. application kill group
		{ {}, "c", {}, {} }, -- 2. client managment group
		{ {}, "r", {}, {} }, -- 3. client managment group
		{ {}, "n", {}, {} }, -- 4. client managment group
		{ {}, "g", {}, {} }, -- 5. run or rise group
		{ {}, "f", {}, {} }, -- 6. launch application group
    { {}, "p", {}, {} }, -- 7. program runner group
	}
	...
	layco:set_keys(layout_tile, "tile")
	...
	self.raw.root = {
...

		{
			...
			{ description = "Go previous tag", group = "Screen navigation" }
		},
		{
			{ env.mod }, "Right", function() awful.screen.focus_relative(1) end,
			{ description = "Jump to next screen", group = "Screen navigation" }
		},
		{
			{ env.mod }, "Left", function() awful.screen.focus_relative(-1) end,
			{ description = "Jump to previous screen", group = "Screen navigation" }
		},
	...
	self.raw.client = {
		...
		{
			{ "Mod4", "Control" }, "Left", function(c) c:move_to_screen(c.screen.index - 1) end,
			{ description = "Move to previous screen.", group = "Client keys" }
		},
		{
			{ "Mod4", "Control" }, "Right", function(c) c:move_to_screen() end,
			{ description = "Move to next screen", group = "Client keys" }
		}
	}
