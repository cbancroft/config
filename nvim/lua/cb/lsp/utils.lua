...
local tbl = require 'cb.utils.table'
...
function M.setup_document_highlight(client, bufnr)
  ...
  local augroup_exists, _ = pcall(vim.api.nvim_get_autocmds, {
...
function M.setup_codelens_refresh(client,bufnr)
  ...
  local augrout_exists, _ = pcall(vim.api.nvim_get_autocmds, {
    group = 'lsp_code_lens_refresh',
  })
  if not augrout_exists then
    vim.api.nvim_create_augroup('lsp_code_lens_refresh', {})
  end
  vim.api.nvim_create_autocmd({'BufEnter', 'InsertLeave'}, {
    group = 'lsp_code_lens_refresh',
    buffer = bufnr,
    callback = vim.lsp.codelens.refreshkk
  })
end
