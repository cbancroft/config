local _, colors = pcall(require, 'cbancroft.theme.colors')
if not colors then
  return
end

local get_highlight = require('cbancroft.theme.utils').get_highlight
local set_highlight = require('cbancroft.theme.utils').set_highlight
